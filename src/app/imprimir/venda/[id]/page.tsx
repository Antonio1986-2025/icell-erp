...
export default async function ImprimirVendaPage({
  ...
  return (
    <div style={{ fontFamily: "'Courier New', monospace", color: "#000", fontSize: "11pt", lineHeight: 1.5, maxWidth: "190mm", margin: "0 auto", padding: "10mm 0" }}>
      <style>{`
      ...
      {/* ===== TERMO DE GARANTIA ===== */}
      <div style={{pageBreakBefore:"always", marginTop:"10mm"}}></div>
