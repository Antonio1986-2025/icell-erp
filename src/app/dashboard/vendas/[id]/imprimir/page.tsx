...
export default async function ImprimirVendaPage({
  ...
  return (
    <div style={{ fontFamily: "'Courier New', monospace", color: "#000", fontSize: "11pt", lineHeight: 1.5, maxWidth: "190mm", margin: "0 auto", padding: "10mm 20px" }}>
      <style>{`
        ...
        * { print-color-adjust: exact; -webkit-print-color-adjust: exact; }
        ...
        .info-grid { display: flex; justify-content: space-between; margin-bottom: 4mm; flex-wrap: wrap; }
        .info-box { border: 1px solid #000; padding: 3mm; flex: 1; margin: 2px; min-width: 200px; }
        ...
        .signatures { display: flex; justify-content: space-between; margin-top: 10mm; flex-wrap: wrap; }
      ...
      {/* Botão de impressão (só aparece na tela, não no PDF) */}
      <div className="no-print" style={{ textAlign: "center", marginBottom: "10px", padding: "10px", background: "#e0e7ff", borderRadius: "8px" }}>
        <p style={{ fontSize: "13px", color: "#1d4ed8", fontWeight: "bold" }}>
          🖨️ Pressione Ctrl+P para imprimir ou salvar como PDF
        </p>
        <p style={{ marginTop: "5px", fontSize: "10px", color: "#555" }}>
          Configure margens como &quot;Mínimo&quot; e desmarque cabeçalho/rodapé nas configurações de impressão.
        </p>
        <p style={{ marginTop: "3px", fontSize: "10px", color: "#888" }}>
          <a href="#" id="printLink" style={{color:"#1d4ed8"}}>Clique aqui para imprimir</a>
        </p>
      </div>
      ...
      <script dangerouslySetInnerHTML={{ __html: `
        document.addEventListener('DOMContentLoaded', function() {
          ...
          // Auto-abre o dialog de impressão após 1s
